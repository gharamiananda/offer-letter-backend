...
exports.payslipController = {
    ...
    createOfferLetter(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield payslip_service_1.payslipService.createOfferLetter(req.body, req.user);
            (0, sendResponse_1.default)(res, {
    ...
    getOfferLetterById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield payslip_service_1.payslipService.getOfferLetterById(req.params.id);
            (0, sendResponse_1.default)(res, {
                statusCode: http_status_codes_1.StatusCodes.CREATED,
                success: true,
