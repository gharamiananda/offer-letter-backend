...
function processOneReleaseLetter(offerLetterData, authUser, organization) {
...
exports.releaseLetterService = {
    ...
    createBulkReleaseLetters(offerLetters, authUser) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield Promise.all(offerLetters.map((data) => limit(() => processOneReleaseLetter(data, authUser, organization))));
            return results;
        });
    },
};
