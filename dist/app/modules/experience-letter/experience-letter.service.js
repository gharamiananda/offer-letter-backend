...
function processOneExperienceLetter(offerLetterData, authUser, organization) {
...
exports.experienceLetterService = {
    ...
    createBulkExperienceLetters(offerLetters, authUser) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const results = yield Promise.all(offerLetters.map((data) => limit(() => processOneExperienceLetter(data, authUser, organization))));
            return results;
        });
    },
};
